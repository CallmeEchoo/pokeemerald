...
const struct SpeciesInfo gSpeciesInfoGen2[] =
{
    ...
    [SPECIES_MEGANIUM] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_GRASS),
        .abilities = { ABILITY_OVERGROW, ABILITY_SOOTHING_SCENT, ABILITY_LEAF_GUARD },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_TOTODILE] =
    {
        ...
        .abilities = { ABILITY_TORRENT, ABILITY_BITE_DOWN, ABILITY_SHEER_FORCE },
...
#define AMPHAROS_DEFENSE (P_UPDATED_STATS >= GEN_6 ? 85 : 75)
    ...
    [SPECIES_SUDOWOODO] =
    {
        ...
        .abilities = { ABILITY_STURDY, ABILITY_AQUAPHOBE, ABILITY_ROCK_HEAD },
        .bodyColor = BODY_COLOR_BROWN,
...
#define CORSOLA_DEFENSES (P_UPDATED_STATS >= GEN_7 ? 95 : 85)
    ...
    [SPECIES_SKARMORY] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_CALTROPS, ABILITY_STURDY, ABILITY_WEAK_ARMOR },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_HOUNDOOM] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_HELL_FIRE, ABILITY_FLASH_FIRE, ABILITY_EERIE_HOWL },
        .bodyColor = BODY_COLOR_BLACK,
